...
class RewardFunction:
    ...
    def fit(self, demo_smiles, model_smiles):
        self.rewardnet.train()
        # D_demo processing
        loss = self.get_reward_gru(demo_smiles, model_smiles)['loss']
    ...
    def get_reward_gru(self, demo_smiles, samples):
        ...
        results = self.rewardnet.compute_reward_gru(demo1_pad_ids, samples_pad_ids)
        return results

    def get_reward(self, demo1_smiles, samples):
        return self.get_reward_gru(demo1_smiles, samples)['reward']
